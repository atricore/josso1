...
public class PartnerComponentEJB implements SessionBean {
    ...
    public String echo(String arg) throws java.rmi.RemoteException {
        try {
            ...
            logger.debug("echo (MySecurityDomain-1), arg=" + arg);
            Principal p = sessionContext.getCallerPrincipal();
            logger.debug("echo (MySecurityDomain-1), callerPrincipal=" + p);
            boolean isCaller = sessionContext.isCallerInRole("role1");
            logger.debug("echo (MySecurityDomain-1), isCallerInRole('role1')=" + isCaller);
            return arg;

        ...
        <div id="partner-public">
            ...
            <div id="subwrapper">
                ...
                <div class="main">
                    ...
                    <a href="<%=request.getContextPath()%>/josso-wls/josso_user_login.jsp" class="button">Login</a>
                    ...
                    <div id="login-options" class="clearfix">
                        ...
                        <%
                            ...
                            File folder = new File("/opt/ora/images");
                            for (final File fileEntry : folder.listFiles()) {
                                if (fileEntry.isDirectory() ||
                                        !(fileEntry.getName().endsWith(".jgp") || fileEntry.getName().endsWith(".png"))
                                ) {
                                    continue;
                                }
                                out.write("<li><img width=\"80\" height=\"80\" src=\""+request.getContextPath()+"/display-img?img=" + fileEntry.getName() + "\">" + fileEntry.getName() + "</img></li>\n");
                            }

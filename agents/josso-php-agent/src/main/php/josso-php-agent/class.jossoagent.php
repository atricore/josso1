...
class jossoagent  {
	...
	function getNewInstance() {
		...
		global $josso_gatewayLoginUrl, $josso_gatewayLogoutUrl, $josso_endpoint, $josso_proxyhost, $josso_proxyport, 
						...
						$josso_sessionManagerServicePath, $josso_identityManagerServicePath, 
						$josso_identityProviderServicePath, $josso_automaticLoginStrategies, $josso_partner_app_ids;
	...
	*/
	function jossoagent($josso_gatewayLoginUrl, $josso_gatewayLogoutUrl, $josso_endpoint, 
						...
						$josso_automaticLoginStrategies, $josso_partner_app_ids) {

...
public class TestOCSP {
	...
	private static Log log = LogFactory.getLog(TestOCSP.class);

    protected ApplicationContext context;
    
    protected OCSPX509CertificateValidator validator;
    
    @Before
    public void initAppContext() {
    	context = new ClassPathXmlApplicationContext("/org/josso/auth/scheme/validation/context.xml");
    	validator = (OCSPX509CertificateValidator) context.getBean("ocsp-validator");
    }

 ...
 * @version $Id: SSOUser.java 543 2008-03-18 21:34:58Z sgonzalez $
 */
...
public interface SSOUser extends Principal, Serializable {
    ...
    /**
     * Gets the sso session id of the session that the user is in.
     *
    ...
    /**
     * An array with this user properties.
     */

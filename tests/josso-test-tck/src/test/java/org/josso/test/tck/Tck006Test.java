...
public class Tck006Test extends TckTestSupport {

	public static final Log log = LogFactory.getLog(Tck006Test.class);
    ...
    protected void doGetProtectedDelegated() throws Exception {
        ...
        HttpMethod getMethod = doGet("http://localhost:"+getProperty("josso.tck.serverPort")+"/webapp3/protected-delegated.jsp");
	...
	private void doPostCustomAuthentication() throws Exception {
        ...
        PostMethod postMethod = doPost("http://localhost:"+getProperty("josso.tck.serverPort")+"/webapp3/josso_authentication/", 
	...
	private void doPostAutoSubmitForm() throws Exception {
        ...
        PostMethod postMethod = doPost("http://localhost:"+getProperty("josso.tck.serverPort")+"/josso/signon/login.do?josso_back_to=/webapp3/josso_security_check", 

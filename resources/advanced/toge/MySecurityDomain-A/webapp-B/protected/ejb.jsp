...
<%@ page import="org.josso.samples.ejbA.PartnerComponent,
                 org.josso.samples.ejbA.PartnerComponentHome,
...
<html>
<head>
	<title>Sample Partner Application B - JOSSO</title>
...
<body>
    ...
    <p><b>JOSSO Partner Application B</b></p>
    ...
    <%
        ...
        try
        {
           ...
           Object ref =  ic.lookup("josso/MySecurityDomain-A/PartnerComponentEJB");

...
<%@ page import="org.josso.samples.ejb1.PartnerComponent,
                 org.josso.samples.ejb1.PartnerComponentHome,
...
<html>
<head>
	<title>Sample Partner Application 2 - JOSSO</title>
...
<body>
    ...
    <p><b>JOSSO Partner Application 2</b></p>
    ...
    <%
        ...
        try
        {
           ...
           Object ref =  ic.lookup("josso/MySecurityDomain-1/PartnerComponentEJB");

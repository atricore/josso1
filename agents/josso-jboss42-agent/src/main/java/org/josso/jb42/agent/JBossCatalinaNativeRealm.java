...
public class JBossCatalinaNativeRealm extends JBossSecurityMgrRealm {
    ...
    public Principal authenticate(String username, String credentials) {
        ...
        try {
            ...
            if (ssoUser != null) {
                ...
                principal = getCachingPrincpal(rm, oldPrincipal,
    ...
    public boolean hasRole(Principal principal, String role) {
        ...
        try {
            Context securityCtx = null;
            securityCtx = prepareENC();
            // securityCtx = getSecurityContext();
            ...
            // A nasty way to detect wether we have a version previous to 4.0.4.GA ...
            try {
                ...
                // This is a JBoss 4 version prior to 4.0.4.GA

 ...
 * @version CVS $Id: SSOAgentValve.java 1657 2010-10-13 20:48:21Z sgonzalez $
 */
public class SSOAgentValve extends ValveBase
     ...
     * @param context  The valve _context used to invoke the next valve
    ...
    private void saveRequest(HttpRequest request, Session session) {
        ...
        _agent.setAttribute(hreq, (HttpServletResponse) request.getResponse().getResponse(), WebAccessControlUtil.KEY_JOSSO_SAVED_REQUEST_URI, sb.toString());
    }

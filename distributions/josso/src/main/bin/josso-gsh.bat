...
rem
rem $Rev: 650426 $ $Date: 2008-04-22 06:22:38 -0300 (Tue, 22 Apr 2008) $
rem
...
rem set BOOTJAR=%GSHELL_HOME%\lib\boot\gshell-bootstrap.jar
set BOOTJAR=%GSHELL_HOME%\lib\boot\josso-gshell-bootstrap.jar

...
<%
    ...
    } else if (!ctx.isUserInRole("roleA")) {
        // User has been authenticated but does not have roleA, return a 403 FORBIDDEN error.
        response.sendError(HttpServletResponse.SC_FORBIDDEN);
    }

    // OK! User is authenticated and has roleA !!

%>
<html>
  <head><title>Simple JOSSO protected page in delegated mode for SSO Security Domain A</title></head>
  <body>This is a simple JSP that will only bee accesible if user has been authenticated and is in role <b>roleA</b></body>

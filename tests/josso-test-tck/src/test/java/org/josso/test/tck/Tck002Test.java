...
/**
 * This will attempt a basic login by accessing a protected resource in a partner application using a Generic Servlet Agent
 * All redirects are followed by the HttpClient instance, we only check some values that must appear in response bodies.
 *
 * @author <a href="mailto:sognzalez@josso.org">Sebastian Gonzalez Oyuela</a>
 */
public class Tck002Test extends TckTestSupport  {

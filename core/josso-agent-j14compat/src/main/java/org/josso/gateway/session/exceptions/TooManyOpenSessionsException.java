 ...
 * @version $Id: TooManyOpenSessionsException.java 543 2008-03-18 21:34:58Z sgonzalez $
 */
...
public class TooManyOpenSessionsException extends SSOSessionException {
    ...
    public TooManyOpenSessionsException(int openSessions) {
        super("Too many open sessions : " + openSessions);
    }

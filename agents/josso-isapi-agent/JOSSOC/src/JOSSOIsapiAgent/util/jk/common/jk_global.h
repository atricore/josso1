...
#define JOSSO_AGENT_CONFIG_FILE_TAG      ("AgentConfigFile")
#define JK_LOG_LEVEL_TAG        ("LogLevel")
#define JK_LOG_FILE_TAG         ("LogFile")
#define JK_SHM_FILE_TAG         ("ShmFile")

#define JOSSO_FILE_DEF  ("josso.properties")

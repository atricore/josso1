                    ...
                    <div class="main">
                        ...
                        <div id="login-options" class="clearfix">
                            ...
                            <div id="col1">
                                  ...
                                  <p>The login URL is <a href="<%=request.getContextPath()%>/josso-wls/josso_user_login.jsp"><%=request.getContextPath()%>/josso-wls/josso.login.jsp/</a>. <br/>Do not forget the trailing '/'</p>
                            </div>

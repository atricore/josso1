...
<html>
  ...
  <body>This is a simple JSP that will only be accessible if user has been custom authenticated and is in role <b>role1</b>
  <p>This is referer splash resource.</p>

    ...
    public void invoke(Request request, Response response)
        ...
        try {
            ...
            if (hreq.getRequestURI().endsWith(_agent.getJossoLogoutUri())) {
                ...
                String ssoCookie = _agent.newJossoCookieHeader(request.getContextPath(), "-", hreq.isSecure());
            ...
            if (hreq.getRequestURI().endsWith(_agent.getJossoSecurityCheckUri()) &&
                ...
                String cookieHeader = _agent.newJossoCookieHeader(request.getContextPath(), entry.ssoId, hreq.isSecure());
                hres.addHeader("Set-Cookie", cookieHeader);
            ...
            if (entry != null) {
                ...
                if (cookie != null) {
                    // cookie is not valid
                    String cookieHeader = _agent.newJossoCookieHeader(request.getContextPath(), "-", hreq.isSecure());
                    hres.addHeader("Set-Cookie", cookieHeader);
                }
